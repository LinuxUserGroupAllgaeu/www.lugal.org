...
module Jekyll
  class OctoLayer < Liquid::Tag
    ...
    def render(context)
      output = super
      if @lat
        caption = "Map Data: <a href='http://openstreetmap.org'>OpenStreetMap</a> contributors <a href='http://www.openstreetmap.org/copyright'>License</a> - Tiles Courtesy of <a href='http://maps.stamen.com/' target='_blank'>stamen</a>"
        source = "<div class='map'><div style='height:300px' id='map#{@mapID}'></div><div class='mapCaption'>#{caption}</div></div>"\
